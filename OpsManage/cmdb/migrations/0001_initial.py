# Generated by Django 2.1.1 on 2018-11-07 08:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('1', '增加'), ('2', '删除'), ('3', '修改')], max_length=64, verbose_name='事件类型')),
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='事件时间')),
                ('log_type', models.CharField(choices=[('1', '普通'), ('2', '部件')], max_length=64, verbose_name='日志类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.CharField(choices=[('1', '防火墙'), ('2', '入侵检测设备'), ('3', '入侵防御设备'), ('4', '综合安全网关'), ('5', '数据库审计系统'), ('6', '运维审计系统'), ('7', '防病毒网关'), ('8', 'WAF防火墙'), ('9', '安全配置核查'), ('10', '网络准入系统'), ('11', '网闸设备'), ('12', 'VPN设备'), ('13', '堡垒机'), ('14', 'DDOS'), ('15', '漏洞扫描'), ('16', 'AUG网络安全审计系统'), ('17', '终端准入控制系统')], max_length=64, verbose_name='安全设备类型')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='cmdb.Asset', verbose_name='资产')),
            ],
            options={
                'verbose_name': '安全设备',
