# Generated by Django 2.1.1 on 2018-11-08 07:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(max_length=128, verbose_name='事件类型')),
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='事件时间')),
                ('log_type', models.CharField(max_length=128, verbose_name='日志类型')),
