# Generated by Django 2.1.1 on 2018-09-04 00:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', '使用中'), ('2', '未使用'), ('3', '故障'), ('4', '其它')], default=0, max_length=50, verbose_name='设备状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cabinet', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cmdb.Cabinet', verbose_name='所在机柜')),
            ],
            options={
                'verbose_name': '机柜位置',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.CharField(choices=[('1', '路由器'), ('2', '交换机'), ('3', '工业交换机'), ('4', '无线控制器'), ('5', '无线AP')], default=0, max_length=64, verbose_name='网络设备类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='parent_level', to='cmdb.Organization')),
            ],
            options={
                'verbose_name': '所属单位',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.CharField(choices=[('1', '防火墙'), ('2', '入侵检测设备'), ('3', '入侵防御设备'), ('4', '综合安全网关'), ('5', '数据库审计系统'), ('6', '运维审计系统'), ('7', '防病毒网关'), ('8', 'WAF防火墙'), ('9', '安全配置核查'), ('10', '网络准入系统'), ('11', '网闸设备'), ('12', 'VPN设备')], default=0, max_length=64, verbose_name='安全设备类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.CharField(choices=[('1', 'PC服务器'), ('2', '小型机'), ('3', '刀片机'), ('4', '虚拟机'), ('5', '容器')], default=0, max_length=64, verbose_name='服务器类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.CharField(choices=[('1', '磁盘阵列'), ('2', '网络存储器'), ('3', '光纤交换机'), ('4', '磁带库'), ('5', '磁带机')], default=0, max_length=64, verbose_name='存储设备类型')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='cmdb.Asset')),
            ],
            options={
                'verbose_name': '存储设备',
        ...
        migrations.AddField(
            ...
            name='vendor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cmdb.Vendor', verbose_name='设备厂商'),
        ),
        migrations.AddField(
            model_name='cabinet',
            name='idc',
        ...
        migrations.AddField(
            model_name='asset',
            name='cabinet',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmdb.Cabinet'),
        ),
        migrations.AddField(
            model_name='asset',
            name='contract',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmdb.Contract', verbose_name='来源合同'),
        ),
        migrations.AddField(
            model_name='asset',
            name='idc',
        ...
        migrations.AddField(
            model_name='asset',
            name='model',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmdb.Device_model', verbose_name='设备型号'),
        ),
        migrations.AddField(
            model_name='asset',
            name='organization',
        ...
        migrations.AddField(
            model_name='asset',
            name='supplier',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmdb.Supplier', verbose_name='供应厂商'),
        ),
        ...
        migrations.AlterUniqueTogether(
            name='port',
            unique_together={('asset', 'ip', 'sub_ip'), ('asset', 'port_name')},
        ),
        migrations.AlterUniqueTogether(
            name='parts',
