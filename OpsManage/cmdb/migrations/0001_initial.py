# Generated by Django 2.1.1 on 2018-11-06 02:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('object', models.CharField(max_length=128, verbose_name='事件对象')),
                ('event_type', models.CharField(choices=[('1', '增加'), ('2', '修改'), ('3', '删除')], max_length=64, verbose_name='事件类型')),
